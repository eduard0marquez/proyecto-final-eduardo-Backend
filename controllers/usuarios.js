...
const usuarioPost = async (req=request, res=response) => {
  ...
  const { nombre, apellido, email, password,direccion,fechaNacimiento, rol,img} = datos;
    const usuario = new Usuario({ nombre, apellido, email, password,direccion,fechaNacimiento, rol, img });
